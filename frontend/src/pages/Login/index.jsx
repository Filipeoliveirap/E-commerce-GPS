...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validação genérica usando validators
    if (!formData.email.trim() || !validators.email(formData.email)) {
          ...
          <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div className="mt-8 text-center">
              <p className="text-xs text-navy-700 dark:text-gray-400">
                ...
                <Link
                  to="/cadastro"
                  className="ml-1 font-bold text-navy-900 dark:text-white hover:text-primary dark:hover:text-primary transition-colors"
                >
                  Cadastre-se
                </Link>
              </p>
